...
namespace AlphaS.BasicDailyData.Tests
{
    ...
    public class BasicDailyDataFileStatusInformationTests
    {
        ...
        {
            var test = new BasicDailyDataFileStatusInformation("2016\t5\tValid\t2016-09-19 21:00");
        ...
        {
            var test1 = new BasicDailyDataFileStatusInformation("2016\t5\tValid\t2016-09-19 21:00");
            var test2 = new BasicDailyDataFileStatusInformation("2016\t6\tValid\t2016-09-19 21:00");
        ...
        {
            var test1 = new BasicDailyDataFileStatusInformation("2016\t5\tValid\t2016-09-19 21:00");
            var test2 = new BasicDailyDataFileStatusInformation("2014\t6\tValid\t2016-09-19 21:00");
            Assert.IsTrue(test2.CompareTo(test1) < 0);
        }
